...
/**
 * BQApplicationArchitectureRequestOutputModel
 */
public class BQApplicationArchitectureRequestOutputModel   {
  ...
  private String applicationArchitectureRequestActionTaskReference = null;

  private Object applicationArchitectureRequestActionTaskRecord = null;

  private String applicationArchitectureRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Application Architecture instance request service call 
   * @return applicationArchitectureRequestActionTaskReference
  **/

  public String getApplicationArchitectureRequestActionTaskReference() {
    return applicationArchitectureRequestActionTaskReference;
  }

  public void setApplicationArchitectureRequestActionTaskReference(String applicationArchitectureRequestActionTaskReference) {
    this.applicationArchitectureRequestActionTaskReference = applicationArchitectureRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return applicationArchitectureRequestActionTaskRecord
  **/

  public Object getApplicationArchitectureRequestActionTaskRecord() {
    return applicationArchitectureRequestActionTaskRecord;
  }

  public void setApplicationArchitectureRequestActionTaskRecord(Object applicationArchitectureRequestActionTaskRecord) {
    this.applicationArchitectureRequestActionTaskRecord = applicationArchitectureRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Application Architecture service request record 
   * @return applicationArchitectureRequestRecordReference
  **/

  public String getApplicationArchitectureRequestRecordReference() {
    return applicationArchitectureRequestRecordReference;
  }

  public void setApplicationArchitectureRequestRecordReference(String applicationArchitectureRequestRecordReference) {
    this.applicationArchitectureRequestRecordReference = applicationArchitectureRequestRecordReference;
  }

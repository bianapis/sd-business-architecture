...
/**
 * BQInformationArchitectureCaptureOutputModel
 */
public class BQInformationArchitectureCaptureOutputModel   {
  ...
  private String informationArchitectureCaptureActionTaskReference = null;

  private Object informationArchitectureCaptureActionTaskRecord = null;

  private String informationArchitectureCaptureRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Information Architecture instance capture service call 
   * @return informationArchitectureCaptureActionTaskReference
  **/

  public String getInformationArchitectureCaptureActionTaskReference() {
    return informationArchitectureCaptureActionTaskReference;
  }

  public void setInformationArchitectureCaptureActionTaskReference(String informationArchitectureCaptureActionTaskReference) {
    this.informationArchitectureCaptureActionTaskReference = informationArchitectureCaptureActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The capture service call consolidated processing record 
   * @return informationArchitectureCaptureActionTaskRecord
  **/

  public Object getInformationArchitectureCaptureActionTaskRecord() {
    return informationArchitectureCaptureActionTaskRecord;
  }

  public void setInformationArchitectureCaptureActionTaskRecord(Object informationArchitectureCaptureActionTaskRecord) {
    this.informationArchitectureCaptureActionTaskRecord = informationArchitectureCaptureActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Information Architecture structured input transaction/record 
   * @return informationArchitectureCaptureRecordReference
  **/

  public String getInformationArchitectureCaptureRecordReference() {
    return informationArchitectureCaptureRecordReference;
  }

  public void setInformationArchitectureCaptureRecordReference(String informationArchitectureCaptureRecordReference) {
    this.informationArchitectureCaptureRecordReference = informationArchitectureCaptureRecordReference;
  }

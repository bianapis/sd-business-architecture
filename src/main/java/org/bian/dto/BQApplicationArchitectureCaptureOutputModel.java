...
/**
 * BQApplicationArchitectureCaptureOutputModel
 */
public class BQApplicationArchitectureCaptureOutputModel   {
  ...
  private String applicationArchitectureCaptureActionTaskReference = null;

  private Object applicationArchitectureCaptureActionTaskRecord = null;

  private String applicationArchitectureCaptureRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Application Architecture instance capture service call 
   * @return applicationArchitectureCaptureActionTaskReference
  **/

  public String getApplicationArchitectureCaptureActionTaskReference() {
    return applicationArchitectureCaptureActionTaskReference;
  }

  public void setApplicationArchitectureCaptureActionTaskReference(String applicationArchitectureCaptureActionTaskReference) {
    this.applicationArchitectureCaptureActionTaskReference = applicationArchitectureCaptureActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The capture service call consolidated processing record 
   * @return applicationArchitectureCaptureActionTaskRecord
  **/

  public Object getApplicationArchitectureCaptureActionTaskRecord() {
    return applicationArchitectureCaptureActionTaskRecord;
  }

  public void setApplicationArchitectureCaptureActionTaskRecord(Object applicationArchitectureCaptureActionTaskRecord) {
    this.applicationArchitectureCaptureActionTaskRecord = applicationArchitectureCaptureActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Application Architecture structured input transaction/record 
   * @return applicationArchitectureCaptureRecordReference
  **/

  public String getApplicationArchitectureCaptureRecordReference() {
    return applicationArchitectureCaptureRecordReference;
  }

  public void setApplicationArchitectureCaptureRecordReference(String applicationArchitectureCaptureRecordReference) {
    this.applicationArchitectureCaptureRecordReference = applicationArchitectureCaptureRecordReference;
  }
